...
"========== One-line settings for copy-paste ==========
...
set completeopt+=longest " only insert the longest common text of the autocomplete matches
...
autocmd VimEnter * if argc() == 0 && !exists("s:std_in") | NERDTreeVCS | wincmd l | endif
